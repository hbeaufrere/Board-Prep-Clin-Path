...
def send_email(recipient_email, subject, html_content):
    ...
    email_from = os.getenv('EMAIL_FROM', 'Vet Clin Path MCQ <onboarding@resend.dev>')
...
def format_mcq_email(mcq_results):
    ...
    <body>
        <div class="header">
            <h1>Vet Clin Path - MCQ Questions</h1>
            <p>Generated from Veterinary Clinical Pathology journals</p>
        </div>
    ...
    html += """
        ...
        <div style="background-color: #edf2f7; padding: 15px; text-align: center; font-size: 0.9em; color: #666;">
            <p>Generated by PubMed MCQ Generator for Veterinary Clinical Pathology</p>
        </div>
    </body>
    </html>
    """
...
def send_mcq_email():
    ...
    subject = f"Vet Clin Path - {len(mcq_results)} MCQ Questions"
